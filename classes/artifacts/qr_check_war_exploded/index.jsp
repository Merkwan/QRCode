...
<div class="container" id="con_table">
	<div class="col-lg-4 col-sm-4 col-xs-4 col-lg-offset-4 col-sm-offset-4 col-xs-offset-4">
		<form action="http://www.txjava.cn:80/qr_check/teacherloginservlet" method="post">
				<table  id="table1" class="table table-bordered">
					<tr>
						<td style="vertical-align: middle;"> <span class="glyphicon glyphicon-user"> </span> 教工号</td>
						<td> <input class="form-control" type="text" name="id" id=" " value="" /></td>
					</tr>
