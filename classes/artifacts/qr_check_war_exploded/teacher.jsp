		...
		<div class="col-lg-9" id="teacher_con">
			...
			<div id="div_set" >
					<table class="table">
						...
						<!-- 二维码的生成配置，其实不能在web端更改，只是显示出来而已
						$("#txtCode").val()+$("#txtVal").val()+"?did="+did+","+stime
						http://qr.topscan.com/api.php?text=http://127.0.0.1:8888/qr_check/servlet/StuQDServlet?did=老师班级id,班级上课开始时间-->
						<tr>
							<td>服务器地址</td>
							<td><input type="text"  class="form-control"  name="" id="txtVal" value="http://127.0.0.1:8888/qr_check/servlet/StuQDServlet"/></td>
							<td></td>
						</tr>
						<tr>
							<td>二维码接口地址</td>
				...
				<div id="form_modify_passwd">
					<table  class="table" style="display:none">
						<tr>
							<td>
								<label>新密码：</label><input type="password" name="spass1">
							</td>
						</tr>
						<tr>
							<td>
								<label>重复新密码：</label><input type="password" name="spass2">
							</td>
						</tr>
            ...
            <div id="div_qd" style="display: none;">
					  ...
					  <div class="tab-content">
					    <div role="tabpanel" class="tab-pane active" id="home" align="center">
							<!--<div id="weixin" style="height: 500px; width: 500px;"></div>-->
...
$(function(){
	...
	/*$("#weixintest").fadeIn(250,function() {
		var obj = new WxLogin({
			id: "weixintest",
			appid: "wx7287a60bb700fd21",
			scope: "snsapi_login",
			redirect_uri: "http://www.hhuqd.cn/loginServlet"
		});
	});*/

	document.getElementById("weixintest").innerHTML = myFunction();
	function myFunction() {
		var obj = new WxLogin({
			id: "weixintest",
			appid: "wx7287a60bb700fd21",
...
function classClick(){ 
		...
		$("#div_set").fadeOut(500,function(){
			...
			$("#div_qd").fadeIn(250,function(){

				});
			});
			$("#weixin").fadeIn(250,function(){
				var obj = new WxLogin({
					id:"weixin",
					appid:"wx7287a60bb700fd21",
					scope:"snsapi_login",
