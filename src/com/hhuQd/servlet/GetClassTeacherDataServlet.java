...
public class GetClassTeacherDataServlet extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public GetClassTeacherDataServlet() {
		super();
	}
	...
	//	String cno = request.getParameter("cno");// 前端需要传递一个
													// 班级的编号，后台返回这个班级中的所有授课老师信息
